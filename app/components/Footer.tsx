...
export default function Footer() {
  return (
    <footer
      id="contact"
      className="scroll-mt-24 border-t border-footer-text/15 bg-footer-surface px-5 py-14 sm:px-8 md:px-12 lg:px-16 lg:py-24"
    >
      <div className="mx-auto max-w-7xl">
        ...
        >
          <div className="flex flex-wrap items-center gap-6">
            <SiteLogo size="footer" ringOffset="footer" />
